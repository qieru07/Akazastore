...
if (!$game_id) {
    $q_find = mysqli_query($conn, "SELECT id, name, thumbnail FROM games WHERE name LIKE '%Free Fire%' OR slug = 'ff' LIMIT 1");
...
<body>
  ...
  <div class="mobile-nav" id="mobileNav">
    ...
    <div class="card-hero-wrapper">
      <div class="card-game">
        <img src="<?= $game_img; ?>" class="game-img" alt="<?= $game_name; ?>" onerror="this.src='../asset/img/freefire.jpg'">
        <div>
        ...
        <div class="form-box">
            <div class="step-card">
              ...
              <div class="step-row-inputs" style="grid-template-columns: 1fr;">
                <div class="field-group">
                  <label class="field-label">ID Game <span class="info-icon" onclick="openInfoModal('User ID', 'Untuk menemukan User ID kamu, buka game Free Fire lalu klik ikon profil di pojok kiri atas. User ID tertera di bawah nama IGN kamu. Pastikan ID yang dimasukkan benar agar diamond masuk ke akun yang tepat.')">ⓘ</span></label>
            ...
            <div class="step-card">
                ...
                <div class="category-section">
                    <h3 class="category-title">Membership</h3>
                    <div class="item-grid" id="membershipItems"></div>
                </div>

                <div class="category-section">
                    <h3 class="category-title">Top Up Instant</h3>
                    <div class="item-grid" id="instantItems"></div>
                </div>
            </div>
            <div class="step-card">
                <div class="step-title-row">
        ...
        <div class="modal-box">
          ...
          <div class="modal-body">
            ...
            <div class="detail-row">
              ...
              <span class="d-val" id="m_product">Free Fire</span>
            </div>
            <div class="detail-row">
