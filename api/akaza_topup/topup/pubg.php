...
$game_name = "PUBG Mobile"; // Default
$game_img = "../asset/img/pubg.jpeg"; // Default fallback

require_once __DIR__ . '/../koneksi.php';

// Jika id tidak dikirim di URL, cari id secara otomatis dari database berdasarkan nama game
if (!$game_id) {
    $q_find = mysqli_query($conn, "SELECT id, name, thumbnail FROM games WHERE name LIKE '%PUBG%' OR slug = 'pubg' LIMIT 1");
...
<body>
  ...
  <div class="mobile-nav" id="mobileNav">
    ...
    <div class="card-hero-wrapper">
      <div class="card-game">
        <img src="<?= $game_img; ?>" class="game-img" alt="<?= $game_name; ?>" onerror="this.src='../asset/img/pubg.jpeg'">
        <div>
          <div class="title"><?= strtoupper($game_name); ?></div>
          <div class="subtitle">Tencent Games</div>
      ...
      <div class="content-layout">
        <div class="form-box">
            ...
            <div class="step-card">
                ...
                <input type="hidden" name="game" value="PUBG Mobile">
                ...
                <div class="category-section">
                    <h3 class="category-title">All Region ✨</h3>
                    <div class="item-grid" id="ucItems"></div>
                </div>
        ...
        <div class="modal-box">
          ...
          <div class="modal-body">
            ...
            <div class="detail-row">
              ...
              <span class="d-val" id="m_product">PUBG Mobile</span>
            </div>
            <div class="detail-row">
