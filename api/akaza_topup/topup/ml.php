...
$game_name = "Mobile Legends"; // Default
$game_img = "../asset/img/Mobile Legend.jpg"; // Default fallback



// Jika id tidak dikirim di URL, cari id secara otomatis dari database berdasarkan nama game
if (!$game_id) {
    $q_find = mysqli_query($conn, "SELECT id, name, thumbnail FROM games WHERE name LIKE '%Mobile Legend%' OR slug = 'ml' LIMIT 1");
...
<body>
  ...
  <div class="mobile-nav" id="mobileNav">
    ...
    <div class="card-hero-wrapper">
        <div class="card-game">
            <img src="<?= $game_img; ?>" class="game-img" alt="<?= $game_name; ?>" onerror="this.src='../asset/img/Mobile Legend.jpg'">
            <div>
      ...
      <div class="content-layout">
        <div class="form-box">
            ...
            <div class="step-card">
              <div class="step-row-inputs">
                <div class="field-group">
                  <label class="field-label">ID <span class="info-icon" onclick="openInfoModal('User ID', 'Untuk menemukan User ID kamu, buka game Mobile Legends lalu klik ikon profil di pojok kiri atas. User ID tertera di bawah nama IGN kamu. Contoh format: 123456789')">ⓘ</span></label>
            ...
            <div class="step-card">
                ...
                <div class="category-section">
                    <h3 class="category-title">Khusus Top Up Pertama Kali per Akun Dimanapun Top Up nya (kalo uda pernah beli jangan ya pasti error nanti) ✨</h3>
                    <div class="item-grid" id="firstTimeItems"></div>
                </div>
            </div>
        ...
        <div class="modal-box">
          ...
          <div class="modal-body">
            ...
            <div class="detail-row">
              ...
              <span class="d-val" id="m_product">Mobile Legends</span>
            </div>
            <div class="detail-row">
