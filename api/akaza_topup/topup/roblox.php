...
$game_name = "Roblox"; // Default
$game_img = "../asset/img/Roblox.png"; // Default fallback
...
<body>
    ...
    <div class="card-hero-wrapper">
      <div class="card-game">
        <img src="<?= $game_img; ?>" class="game-img" alt="<?= $game_name; ?>" onerror="this.src='../asset/img/Roblox.png'">
        <div>
          <div class="title"><?= strtoupper($game_name); ?></div>
          <div class="subtitle">Roblox Corporation</div>
          <div class="badge-container">
            <div class="badge">⚡ Proses Cepat</div>
            <div class="badge">💬 Layanan Chat 24/7</div>
        ...
        <div class="form-box">
            <div class="step-card">
              <div class="step-title-row">
                ...
                <h2 class="step-heading">Masukkan Data Akun</h2>
              </div>
              <div class="step-row-inputs" style="grid-template-columns: 1fr;">
                <div class="field-group">
                  <label class="field-label">Username Roblox <span class="info-icon" onclick="openInfoModal('Username Roblox', 'Masukkan Username Roblox Anda yang benar. Harap diperhatikan kapitalisasi hurufnya agar Robux berhasil terkirim.')">ⓘ</span></label>
                  <input type="text" name="user_id" id="userid" placeholder="Masukkan Username Roblox" required class="field-input" />
                </div>
              </div>
            ...
            <div class="step-card">
                ...
                <input type="hidden" name="game" value="Roblox">
                ...
                <div class="category-section">
                    <h3 class="category-title">Robux (Voucher / Direct)</h3>
                    <div class="item-grid" id="robuxItems"></div>
                </div>
            </div>
            <div class="step-card">
                <div class="step-title-row">
        ...
        <div class="modal-box">
          ...
          <div class="modal-body">
            ...
            <div class="detail-row">
              ...
              <span class="d-val" id="m_product">Roblox</span>
            </div>
            <div class="detail-row">
