                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <img src="{{ str_starts_with($game->thumbnail, 'http') ? $game->thumbnail : asset('images/games/'.$game->thumbnail) }}" class="h-12 w-12 rounded-lg object-cover shadow-sm border border-gray-300">
                                    </td>
